	...
	public static class AppInitializer
	{
		...
		public static void InitializeScreens(Platform platform)
		{
			if (platform == Platform.iOS) {
				FeatureContext.Current.Add (ScreenNames.ConferencesList, new Screens.iOS.ConferencesList ());
				//FeatureContext.Current.Add (ScreenNames.AddTask, new iOSAddTaskScreen ());
			} else if (platform == Platform.Android) {
				FeatureContext.Current.Add (ScreenNames.ConferencesList, new Screens.Android.ConferencesList ());
